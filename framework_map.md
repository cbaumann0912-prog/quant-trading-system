...
```
Note: PC2 Carry Regime never got its own file in `research/strategies/` — it was evaluated purely through `daily_audit/` entries (Days 18–19, 38, 40, 41) rather than a one-page spec, a real deviation from the "write a spec first" plan.