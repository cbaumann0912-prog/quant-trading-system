...
The check could not have been informative either way, and this is measured rather than asserted. All three confidence intervals span zero, on the closing run and on both regenerations. The deciding gap between k = 2.0 and k = 2.5 was +0.050 basis points against a standard error of 1.014 when the strategy was closed — a t-statistic of 0.05 — and is +0.042 against 1.013 now, a t-statistic of 0.04. The per-k standard errors are 0.346, 0.547 and 0.853 basis points against 0.346, 0.548 and 0.853 then, so the dispersion of this ladder never moved; only its ordering did. Four trades out of 1,588 flip that ordering, and at an excess kurtosis of +22.5 a handful of extremes decides it. Year by year the ladder is monotone in 2 of 11 tradeable years.
