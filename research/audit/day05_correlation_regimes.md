...
**GBPUSD/USDJPY** — 26 regime breaks with an average duration of 30 days. 
The longest ran from May 2016 to August 2016 at 102 days, coinciding with the Brexit referendum.

**EURUSD/USDJPY** — 22 regime breaks with an average duration of 38 days. 
The longest ran from October 2012 to May 2013 at 197 days during the European sovereign debt crisis.
...
On a $100K book, ignoring these signals means running position sizes calibrated to a market structure that no longer exists. That's not a edge case — the data shows an average of 19 regime breaks per pair over 15 years, roughly one every nine months.
