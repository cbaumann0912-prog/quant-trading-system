...
- **Normality:** ε ~ N(0, σ²) — challenged; excess kurtosis of 3.115 indicates fat tails. CLT provides asymptotic cover at n = 4,054, but tail probabilities remain understated.
...
| Variance | 0.000014 | Estimated σ² of the residuals. The typical residual is √0.000014 ≈ 38 basis points per day — the basis risk that GBP/USD does not explain. |
| Excess Kurtosis | 3.114929 | Residual tails are materially fatter than normal. Confidence intervals and t-statistics on the hedge ratio are less reliable than they appear, particularly in the tails. |
| Ljung-Box Stat | 27.789085 | Compared to χ²(20) critical value of 31.4 at the 5% level. Since 27.789 < 31.4, we fail to reject the null of no serial correlation. |
| Ljung-Box p-value | 0.114487 | Fail to reject at either the 5% or 10% level. No evidence of serial correlation in the residuals out to 20 lags. |
| Lag-1 Autocorr | −0.001125 | Economically negligible. Today's residual carries virtually no information about tomorrow's. |

## 6. Alternative Explanations
Day 4 measured excess kurtosis of 2.65 on raw EUR/USD log returns. After removing the GBP/USD linear relationship, residual kurtosis rises to 3.115. If GBP/USD were absorbing tail events proportionally, residual kurtosis would fall. It does not — it increases. This means GBP/USD is not the driver of EUR/USD during extreme market days. The tail events are largely orthogonal to the hedge.

A second explanation: the 13-year window spans structurally different regimes — the 2015 SNB shock, Brexit, COVID. Extreme residuals from these episodes inflate kurtosis even if within-regime errors are approximately normal. The fat tails may be episodic rather than a permanent feature of the distribution.

## 7. Open Questions
The hedge ratio β = 0.5355 is a static full-sample estimate. A single coefficient estimated across 13 years of structurally different regimes may not be stable. Walk-forward validation, put off for a later date, will test whether this number holds out-of-sample or drifts materially across sub-periods. A rolling hedge ratio is worth evaluating against the static estimate.

Lag-1 autocorrelation of −0.001 is near zero, implying a half-life of approximately 0.7 days (t₁/₂ = ln(2) / (1 − 0.001)). Mean reversion at sub-daily frequency means any stat-arb strategy on this pair would need to operate intraday to capture the reversion timing. Note: this autocorrelation is measured on the OLS regression residuals, not the spread itself — the formal OU half-life will be computed at a later date using the cointegration spread directly.
