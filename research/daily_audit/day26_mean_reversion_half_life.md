...
- Treats each pair's hedge ratio as fixed for the full sample, despite the rolling hedge ratio instability already documented in the Day 24 audit for EUR/USD~GBP/USD (std=0.396, range=−0.11 to +1.57).
...
For EUR/USD~GBP/USD, the strongest of the three: half-life ≈ 220 calendar days (~7.3 months). A mean-reversion trade entered on this spread would expect to wait roughly 7 months before the deviation closes half its distance back to mu. EUR/USD~USD/JPY and GBP/USD~USD/JPY produced longer half-lives of 349 and 426 days respectively.
...
Z-score thresholds for EUR/USD~GBP/USD, derived from mu = -0.001985, sigma = 0.004432:
...
The half-life results are consistent with the Day 24 and Day 25 findings: EUR/USD~GBP/USD was borderline at p=0.0621 in Engle-Granger, failing after BH correction, and Johansen found rank 0 system-wide. A 220-day half-life on a spread that already fails cointegration testing at the 5% level does not indicate a tradeable edge — it indicates a regression artifact on a spread without statistically supported long-run equilibrium.

The rolling hedge ratio instability documented in Day 24 also means the EUR/USD~GBP/USD residual series is not a stable object. The OU parameters estimated here use a full-sample, fixed-hedge-ratio spread, which may not generalize to a rolling implementation.
