...
## Method
`intraday_overshoot_h1.py`, rebuilt from raw 1-minute bars every run via `src/signals/intraday_overshoot.py`. No cached intermediates. Ten pairs, 2011–2023, k = 2.0, +5 minute entry, 259.44 obs/yr empirical annualization over 12.99 years.
