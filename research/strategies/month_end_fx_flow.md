...
## 3. Data
All 10 pairs from the outset, so universe selection cannot become a post-hoc degree of freedom the way it did in `day56_regime_conditional_performance.md`.
